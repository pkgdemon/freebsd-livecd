...
# unionfs/gunion overlay, not from these cdroot copies.
...
# (where the gunion-backed UFS overlay mounts the rootfs at boot,
# with all pkg-installed firmware files visible inside).
#
...
# gunion view, finds the file. Verified working on Lenovo (iwlwifi-8260)
